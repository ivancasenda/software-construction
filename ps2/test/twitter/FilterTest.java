...
public class FilterTest {
     ...
     * 
     * writtenBy Test Partition
     * - Multiple tweet single result
     * - Multiple tweet multiple results
     * - Mutliple tweet zero result
     *  
     *  inTimespan Test Partition
     *  - Multiple tweet multiple results
     *  - Timespan with the same start and end
     * 
     *  containing Test Partition
     *  - One word one result
     *  - Multiple word multiple result
     *  - Multiple word zero result
     */
    ...
    @Test
    public void testWrittenByMultipleTweetsMutipleResults() {
    	
    	final Instant d1 = Instant.parse("2016-02-17T10:00:00Z");
        final Instant d2 = Instant.parse("2016-02-17T11:00:00Z");
        
        final Tweet tweet1 = new Tweet(1, "alyssa", "is it reasonable to talk about rivest so much?", d1);
        final Tweet tweet2 = new Tweet(2, "alyssa", "rivest talk in 30 minutes #hype", d2);
    ...
    @Test
    public void testInTimespanWithSameStartEnd() {
    	
    	final Instant d1 = Instant.parse("2016-02-17T09:00:00Z");
        final Instant d2 = Instant.parse("2016-02-17T11:00:00Z");
    ...
    @Test
    public void testContainingOneWordOneResult() {
    	final Instant d1 = Instant.parse("2016-02-17T10:00:00Z");
        final Instant d2 = Instant.parse("2016-02-17T11:00:00Z");
    ...
    @Test
    public void testContainingMultipleWordsZeroResult() {
    	final Instant d1 = Instant.parse("2016-02-17T10:00:00Z");
        final Instant d2 = Instant.parse("2016-02-17T11:00:00Z");
        ...
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2), Arrays.asList("the", "greatest"));
